 ...
 ****************************************************************************************
 */
extern "C" bool gapm_is_audio_am0_sup(void);
 ...
 ****************************************************************************************
 */
extern "C" bool gapm_is_embedded_host(void);
 ...
 ****************************************************************************************
 */
extern "C" void gapm_set_embedded_host(bool enable);
 ...
 ****************************************************************************************
 */
extern "C" public_key_t* gapm_get_local_public_key(void);
 ...
 ****************************************************************************************
 */
extern "C" uint8_t gapm_le_psm_get_info(uint16_t le_psm, uint8_t conidx, ke_task_id_t *app_task, uint8_t *sec_lvl);
 ...
 ****************************************************************************************
 */
extern "C" uint8_t gapm_lecb_register(uint16_t le_psm, bool peer_con_init);
 ...
 ****************************************************************************************
 */
extern "C" uint8_t gapm_lecb_unregister(uint16_t le_psm, bool peer_con_init);
